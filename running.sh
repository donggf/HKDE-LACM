...
# 定义 Python 文件名
PYTHON_SCRIPTS=("Split_dataset.py" "fintue_model.py" "gain_prediction.py" "Split_forward_and_reverse.py" "Obtain_complete_embeddings.py" "Obtain_incorrect_complete_embeddings.py")
