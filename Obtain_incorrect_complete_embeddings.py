...
dev_data = pd.read_csv("data/sample_data/result/dev_incorrect_sequence_embeddings.tsv", sep='\t')
merged_data = pd.concat([train_data, dev_data], ignore_index=True)
print("1")

# Divide the sequence into 1024 features:
# Load the file.
output_path_train =  "data/sample_data/train/result/merged_incorrect_sequence_embeddings_1024.tsv"
output_path_test =  "data/sample_data/test/result/merged_incorrect_sequence_embeddings_1024.tsv"
data = merged_data
