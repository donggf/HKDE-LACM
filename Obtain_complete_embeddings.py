...
val_data = pd.read_csv("data/sample_data/result/val_correct_sequence_embeddings.tsv", sep='\t')
merged_data = pd.concat([train_data, test_data, val_data], ignore_index=True)


# Divide the sequence into 1024 features:
# Load the file.
output_path = target_dictionary + "merged_correct_sequence_embeddings_1024.tsv"
data = merged_data
